...
fun ReplyHomeScreen(
    ...
    if (navigationType ==ReplyNavigationType.PERMANENT_NAVIGATION_DRAWER
        ...
        val navigationDrawerContentContentDescription = stringResource(R.string.navigation_drawer)
        PermanentNavigationDrawer(
            ...
            modifier = Modifier.testTag(navigationDrawerContentContentDescription)
        ) {
            ReplyAppContent(
